...
c_dim = 3           # for rgb
t_dim = 40         # text feature dimension
...
output_dim=1
def SN_discriminator(x,y, update_collection=tf.GraphKeys.UPDATE_OPS):
    ...
    c0_0 = hidden_activation(conv2d(   h,  64, 3, 3, 1, 1, spectral_normed=True, update_collection=update_collection, stddev=0.02, name='c0_0'))
    ...
    l4 = linear(c3_0, output_dim, spectral_normed=True, update_collection=update_collection, stddev=0.02, name='l4')

    return tf.sigmoid(tf.reshape(l4, [-1]))
